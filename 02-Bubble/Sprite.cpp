...
void Sprite::render() const
{
	...
	glm::mat4 modelview = glm::translate(glm::mat4(1), glm::vec3(position.x, position.y, 0.f));
...
void Sprite::setAnimation(int animId, int sKey, int length, int keyframesPerSec)
{
	Anim a;
	a.startframe = sKey;
	a.keyframes = length;
